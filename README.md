...
| **File Filter (Local Scan)** | Filter scan results to specific files via a searchable, resizable dropdown of distinct files with issue counts; sort by name or issue count |
